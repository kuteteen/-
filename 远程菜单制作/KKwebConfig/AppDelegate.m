...
//这里是配置这个二级菜单下面的子功能
    //子功能1
     ...
     button2_1.searchValue = @[@"1097285734",@"-1048548775"]; //搜索的值
     button2_1.editValue = @[@"1088897124",@"-1048548775"]; //修改的值
     button2_1.range = @[@"all",@"all"];
     button2_1.valueType = @[@(DLGMemValueTypeSignedInt),@(DLGMemValueTypeSignedInt)]; //数据类f型
     ...
     button2_2.searchValue = @[@"1097285734",@"-1048548775"]; //搜索的值
     button2_2.editValue = @[@"1105674340",@"-1040160166"]; //修改的值
     button2_2.range = @[@"all",@"all"];
     button2_2.valueType = @[@(DLGMemValueTypeSignedInt),@(DLGMemValueTypeSignedInt)];//数据类型
     ...
     button2_3.searchValue = @[@"1097285734",@"-1048548775"]; //搜索的值
     button2_3.editValue = @[@"1110274123",@"-1035952249"]; //修改的值
     button2_3.range = @[@"all",@"all"];
     button2_3.valueType = @[@(DLGMemValueTypeSignedInt),@(DLGMemValueTypeSignedInt)]; //数据类型
     ...
     button2_5.searchValue = @[@"1097285734",@"-1048548775"]; //搜索的值
     button2_5.editValue = @[@"1116768305",@"-1029667599"]; //修改的值
     button2_5.range = @[@"all",@"all"];
     button2_5.valueType = @[@(DLGMemValueTypeSignedInt),@(DLGMemValueTypeSignedInt)]; //数据类型
